...
export type CredentialNavigationProps = BottomTabScreenProps<
  HomeNavigationParamList,
  'CredentialNavigation'
>
export type ShareNavigationProps = BottomTabScreenProps<
  HomeNavigationParamList,
  'ShareNavigation'
>
export type AddNavigationProps = BottomTabScreenProps<
  HomeNavigationParamList,
  'AddNavigation'
>
export type SettingsNavigationProps = BottomTabScreenProps<
  HomeNavigationParamList,
  'SettingsNavigation'
>
